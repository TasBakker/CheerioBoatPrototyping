...
The information provided is from the current preprint: "Active Cheerios: 3D-Printed Marangoni-Driven Active Particles at an Interface" Wilt, J. K., Schramma, N., Bottermans, J. W., & Jalaal, M. (2024). ActiveCheerios: 3D-Printed Marangoni-Driven Active Particles at an Interface. arXiv preprint arXiv:2411.16011.

**Materials and Equipment**

3D Printer: Ultimaker S3 fused filament fabrication (FFF) machine. Printing Material: Polylactic acid (PLA) thermoplastic. In this study, red PLA was used, but any color is suitable. PLA is moderately biodegradable (under certain conditions), and other biodegradable materials are recommended for environmental considerations.
